...
Terraform – Provision AWS S3 bucket (via LocalStack)
LocalStack – Local AWS cloud emulation
Python ETL – Extract, Transform, Load CSV data
Docker – Containerize ETL application
...
✅ Step 2: Infrastructure as Code (Terraform + LocalStack)
...
✅ Step 3: ETL Application (Python + Docker)
...
✅ Step 9: Final Submission Readiness
...
✔ Successful GitHub Actions workflow runs are visible in the Actions tab
✔ processed/output.csv is generated by the ETL job
